...
@section('content')
    <div class="container mx-auto px-4 py-8">
        <div class="max-w-2xl mx-auto">
            ...
            <!-- Form -->
            <form method="POST" action="{{ route('consultant.contact.config.update') }}">
                @csrf
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
                    ...
                    <div class="p-5 border-b border-gray-100">
                        ...
                        <input type="text" name="address" value="{{ \App\Models\Setting::get('address') }}"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:border-yellow-400 focus:outline-none"
                    ...
                    <div class="p-5">
                        ...
                        <input type="text" name="working_hours" value="{{ \App\Models\Setting::get('working_hours') }}"
                            class="w-full px-4 py-2 border border-gray-200 rounded-lg focus:border-yellow-400 focus:outline-none"
