    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex items-center justify-between h-20">
            ...
            <div class="hidden lg:flex items-center gap-2 xl:gap-4">
                <a href="{{ route('home') }}"
                    class="text-gray-700 hover:text-yellow-600 font-semibold transition text-sm xl:text-base relative group">
                    الرئيسية
                    <span
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <a href="{{ route('universities.index') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 rounded-t-lg transition">جميع
                            الجامعات</a>
                        <div class="border-t border-gray-100 my-1"></div>
                        <a href="{{ route('universities.index', ['type' => 'public']) }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 transition">جامعات
                            حكومية</a>
                        ...
                        <a href="{{ route('universities.ranking') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 transition">ترتيب
                            الجامعات</a>
                        <a href="{{ route('universities.recognitions') }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 rounded-b-lg transition">الجامعات
                            المعترف بها</a>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <a href="{{ route('university-quotas.index', ['type' => 'undergraduate']) }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 rounded-t-lg">تقويم
                            المفاضلات</a>
                        <a href="{{ route('university-quotas.index', ['type' => 'postgraduate']) }}"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 rounded-b-lg">تقويم
                            الدراسات العليا</a>
                    </div>
                </div>
                ...
                <div class="relative group">
                    ...
                    <div
                        ...
                        <a href="{{ route('articles.index') }}?category=turkey-studies"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 transition">الدراسة
                            في تركيا</a>
                        <a href="{{ route('articles.index') }}?category=exams"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 transition">اختبارات
                            القبول</a>
                        <a href="{{ route('articles.index') }}?category=scholarships"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 transition">المنح
                            الدراسية</a>
                        <a href="{{ route('articles.index') }}?category=certificates"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 transition">أهم
                            الشهادات</a>
                        <a href="{{ route('articles.index') }}?category=testimonials"
                            class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 rounded-b-lg transition">قصص
                            النجاح</a>
                    </div>
                </div>
                ...
                <!-- Google Translate Buttons (Fixed) -->
                <div class="flex items-center gap-1">
                    ...
                    <button onclick="translatePage('tr')"
                        class="px-1.5 py-0.5 text-xs rounded hover:bg-gray-100 transition">🇹🇷 T</button>
                    <button onclick="translatePage('en')"
                        class="px-1.5 py-0.5 text-xs rounded hover:bg-gray-100 transition">🇬🇧 E</button>
                </div>
            </div>
            ...
            <div class="hidden lg:flex items-center gap-4">
                        ...
                        <div
                            ...
                            @if(Auth::user()->isAdmin() || Auth::user()->isSuperAdmin())
                                <a href="{{ route('consultant.dashboard') }}"
                                    class="block px-4 py-2 text-gray-700 hover:bg-yellow-50 hover:text-yellow-600 rounded-t-lg transition">لوحة
                                    التحكم</a>
                            @else
                            ...
                            <form method="POST" action="{{ route('logout') }}" class="block">
                                @csrf
                                <button type="submit"
                                    class="w-full text-right px-4 py-2 text-gray-700 hover:bg-red-50 hover:text-red-600 rounded-b-lg transition">تسجيل
                                    خروج</button>
                            </form>
                        </div>
                    </div>
                @else
                    <a href="{{ route('login') }}"
                        class="px-6 py-2 text-yellow-600 border-2 border-yellow-600 hover:bg-yellow-50 font-bold rounded-lg transition">تسجيل
                        الدخول</a>
                    <a href="{{ route('register') }}"
                        class="px-6 py-2 bg-yellow-600 hover:bg-yellow-700 text-white font-bold rounded-lg transition shadow-lg">إنشاء
                        حساب</a>
                @endauth
            </div>
            ...
            <div class="lg:hidden flex items-center gap-4">
                @auth
                    <a href="{{ route('dashboard') }}"
                        class="px-4 py-2 bg-yellow-600 text-white rounded-lg font-semibold transition-all">لوحتي</a>
                @else
                    <a href="{{ route('login') }}"
                        class="px-4 py-2 text-yellow-600 border-2 border-yellow-600 rounded-lg font-semibold">دخول</a>
                @endauth
