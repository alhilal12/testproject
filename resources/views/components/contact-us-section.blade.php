    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div class="space-y-8 contact-info-section">
                ...
                <div
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-600" style="font-family: 'Cairo', 'Segoe UI', sans-serif;">
                            {{ \App\Models\Setting::get('address') ?: 'إسطنبول، تركيا' }}
                        </p>
                    </div>
                </div>
                ...
                <a href="{{ $whatsappLink }}" target="_blank"
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-600 group-hover:text-green-600 transition-colors"
                            ...
                            {{ $whatsappNumber ?: '+90 534 732 8625' }}
                        </p>
                ...
                @endphp
                <a href="mailto:{{ $contactEmail ?: 'info@alhilal-education.com' }}"
                    class="contact-card group flex items-start gap-4 p-6 rounded-lg hover:bg-yellow-50 transition-all duration-500 transform hover:translate-x-2 cursor-pointer block">
                    <div class="flex-shrink-0">
                        <div
                    ...
                    <div class="flex-1">
                        ...
                        <p class="text-gray-600 group-hover:text-yellow-600 transition-colors"
                            style="font-family: 'Cairo', 'Segoe UI', sans-serif;">
                            {{ $contactEmail ?: 'info@alhilal-education.com' }}
                        </p>
                ...
                <form action="{{ route('contact.store') }}" method="POST" class="space-y-4">
                    ...
                    <div class="form-group">
                        <input type="tel" id="phone" name="phone"
                            value="{{ old('phone', Auth::check() && Auth::user()->studentProfile ? Auth::user()->studentProfile->phone : '') }}"
                    ...
                    <div class="form-group">
                        <textarea id="message" name="message" rows="5" placeholder="رسالتك" required
                            class="w-full px-4 py-3 border-2 border-gray-300 rounded-lg focus:border-yellow-600 focus:outline-none transition-all duration-300 focus:shadow-lg resize-none">{{ old('message') }}</textarea>
                        @error('message')
                            <span class="text-red-500 text-sm mt-1">{{ $message }}</span>
                        @enderror
                    </div>
