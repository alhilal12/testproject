    ...
    <div class="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="max-w-3xl mx-auto text-center mb-16">
            <h2 class="text-4xl sm:text-5xl font-bold text-gray-900 mb-4"
                ...
                <?php echo e($title ?? 'من نحن'); ?>

            </h2>
            <p class="text-lg text-gray-600 mb-2" style="font-family: 'Cairo', 'Segoe UI', sans-serif;">
                <?php echo e($subtitle ?? 'رحلتنا نحو تحقيق أحلام الطلاب الأكاديمية'); ?>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center mb-16">
            ...
            <div class="relative group">
                ...
                <div
                    ...
                    <img src="<?php echo e($image ?? asset('images/about-us.jpg')); ?>" alt="من نحن - الهلال للاستشارات التعليمية"
            ...
            <div class="space-y-6">
                ...
                <div class="space-y-4">
                    <p class="text-lg text-gray-700 leading-relaxed"
                        ...
                        تقديم استشارات شاملة وموثوقة للطلاب الراغبين في الدراسة بالجامعات التركية. بفريق متخصص وخبرة
                    ...
                    <p class="text-lg text-gray-700 leading-relaxed"
                        ...
                        جوانب رحلة الدراسة في تركيا، من اختيار التخصص والجامعة المناسبة، وحتى الحصول على التأشيرة
                        والإقامة.
                    </p>
                </div>
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8 py-12 border-t-2 border-b-2 border-gray-200">
            ...
            <?php $__currentLoopData = $stats; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $stat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="text-center group/stat transform transition-all duration-300 hover:scale-110">
                    ...
                    <div class="text-4xl font-bold text-yellow-600 mb-2 counter" data-target="<?php echo e($stat['number']); ?>">
                        0
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <?php
                    $reasons = [
                        ...
                        [
                            'title' => 'فريق متخصص',
                            'description' => 'متخصصون في التعليم العالي والجامعات التركية',
                            'color' => 'purple'
                        ],
                        [
                            'title' => 'دعم 24/7',
...
</script><?php /**PATH C:\Users\DELL\Desktop\testproject-master\testproject-master\resources\views/components/about-section.blade.php ENDPATH**/ ?>