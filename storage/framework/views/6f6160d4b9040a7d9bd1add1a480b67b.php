...
<?php $__env->startSection('title', 'الدول المعترف بها - ' . $university->name_ar); ?>
    ...
    <div class="container mx-auto px-4 py-8">
        <div class="bg-white rounded-xl shadow-lg overflow-hidden">
            <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 px-6 py-4 flex justify-between items-center">
                <h1 class="text-2xl font-bold text-white">🌍 الدول المعترف بها: <?php echo e($university->name_ar); ?></h1>
            ...
            <div class="p-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4 mb-6">
                    ...
                    <form action="<?php echo e(route('admin.universities.recognitions.store', $university->id)); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                ...
                <div class="overflow-x-auto">
                    <table class="w-full">
                        ...
                        <tbody>
                            <?php $__empty_1 = true; $__currentLoopData = $university->recognitions; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $recognition): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                <tr class="border-b hover:bg-gray-50">
                                    <td class="px-4 py-2"><?php echo e($recognition->country_code); ?></td>
                                    <td class="px-4 py-2"><?php echo e($recognition->country_name_ar); ?></td>
                                    <td class="px-4 py-2"><?php echo e($recognition->country_name_en ?? '—'); ?></td>
                                    <td class="px-4 py-2"><?php echo e($recognition->notes ?? '—'); ?></td>
                                    <td class="px-4 py-2 text-center">
                                        <span
                                            class="px-2 py-1 rounded-full text-xs <?php echo e($recognition->is_active ? 'bg-green-100 text-green-700' : 'bg-gray-100 text-gray-700'); ?>">
                                            <?php echo e($recognition->is_active ? 'نشط' : 'غير نشط'); ?>

                                        </span>
                                    </td>
                                    <td class="px-4 py-2 text-center">
                                        <form
                                            action="<?php echo e(route('admin.universities.recognitions.destroy', [$university->id, $recognition->id])); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\testProject\resources\views/admin/universities/recognitions.blade.php ENDPATH**/ ?>