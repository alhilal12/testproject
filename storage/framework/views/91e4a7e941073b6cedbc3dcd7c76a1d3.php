...
<?php endif; ?>
    <div class="container mx-auto px-4 py-10 max-w-6xl">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 px-6 py-4">
                <h1 class="text-2xl font-bold text-white">تعديل الجامعة: <?php echo e($university->name_ar); ?></h1>
            </div>
    ...
    📚 البرامج الدراسية
            ...
            <div id="basicTab" class="p-6">
                <form action="<?php echo e(route('admin.universities.update', $university->id)); ?>" method="POST"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div><label class="block font-semibold mb-2">🏫 الاسم (عربي) *</label><input type="text"
                                name="name_ar" value="<?php echo e(old('name_ar', $university->name_ar)); ?>" required
                        ...
                        <div><label class="block font-semibold mb-2">🏛️ الاسم (تركي) *</label><input type="text"
                                name="name_tr" value="<?php echo e(old('name_tr', $university->name_tr)); ?>" required
                                class="w-full px-4 py-2 border-2 rounded-lg"></div>
                        <div><label class="block font-semibold mb-2">📍 المدينة *</label><input type="text" name="city"
                                value="<?php echo e(old('city', $university->city)); ?>" required
                                class="w-full px-4 py-2 border-2 rounded-lg"></div>
                        <div><label class="block font-semibold mb-2">🏷️ النوع *</label><select name="type"
                                class="w-full px-4 py-2 border-2 rounded-lg">
                                <option value="public" <?php echo e($university->type == 'public' ? 'selected' : ''); ?>>🏢 حكومية
                                </option>
                                <option value="private" <?php echo e($university->type == 'private' ? 'selected' : ''); ?>>🏛️ خاصة
                                </option>
                            </select></div>
                        <div><label class="block font-semibold mb-2">📅 تاريخ التأسيس</label><input type="text"
                                name="established_date"
                                value="<?php echo e(old('established_date', $university->established_date)); ?>"
                        ...
                        <div><label class="block font-semibold mb-2">🌐 الموقع الإلكتروني</label><input type="url"
                                name="website" value="<?php echo e(old('website', $university->website)); ?>"
                                class="w-full px-4 py-2 border-2 rounded-lg"></div>

                        <div class="col-span-2"><label class="block font-semibold mb-2">🌐 لغات التدريس</label>
                            <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
                                <?php $currentLangs = is_array($university->languages) ? $university->languages : json_decode($university->languages, true) ?? []; ?>
                                <label><input type="checkbox" name="languages[]" value="turkish" <?php echo e(in_array('turkish', $currentLangs) ? 'checked' : ''); ?>> 🇹🇷 تركي</label>
                                <label><input type="checkbox" name="languages[]" value="english" <?php echo e(in_array('english', $currentLangs) ? 'checked' : ''); ?>> 🇬🇧 إنجليزي</label>
                                <label><input type="checkbox" name="languages[]" value="arabic" <?php echo e(in_array('arabic', $currentLangs) ? 'checked' : ''); ?>> 🇸🇦 عربي</label>
                                <label><input type="checkbox" name="languages[]" value="german" <?php echo e(in_array('german', $currentLangs) ? 'checked' : ''); ?>> 🇩🇪 ألماني</label>
                                <label><input type="checkbox" name="languages[]" value="french" <?php echo e(in_array('french', $currentLangs) ? 'checked' : ''); ?>> 🇫🇷 فرنسي</label>
                                <label><input type="checkbox" name="languages[]" value="spanish" <?php echo e(in_array('spanish', $currentLangs) ? 'checked' : ''); ?>> 🇪🇸 إسباني</label>
                                <label><input type="checkbox" name="languages[]" value="italian" <?php echo e(in_array('italian', $currentLangs) ? 'checked' : ''); ?>> 🇮🇹 إيطالي</label>
                                <label><input type="checkbox" name="languages[]" value="russian" <?php echo e(in_array('russian', $currentLangs) ? 'checked' : ''); ?>> 🇷🇺 روسي</label>
                                <label><input type="checkbox" name="languages[]" value="russian" <?php echo e(in_array('russian', $currentLangs) ? 'checked' : ''); ?>>  بلغارية</label>
                                <label><input type="checkbox" name="languages[]" value="russian" <?php echo e(in_array('russian', $currentLangs) ? 'checked' : ''); ?>>  صينية</label>
                                <label><input type="checkbox" name="languages[]" value="russian" <?php echo e(in_array('russian', $currentLangs) ? 'checked' : ''); ?>>  كورية</label>
                                <label><input type="checkbox" name="languages[]" value="russian" <?php echo e(in_array('russian', $currentLangs) ? 'checked' : ''); ?>>  ارمينية</label>
                            </div>
                        </div>
                        ...
                        <div class="col-span-2"><label class="block font-semibold mb-2">📅 ربط بيانات التقويم</label>
                            <div class="grid grid-cols-2 gap-2 border rounded-lg p-4 bg-gray-50 max-h-60 overflow-auto">
                                ...
                                $linkedIds = $university->quotas->pluck('id')->toArray(); ?>
                                <?php $__currentLoopData = $allQuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><label><input type="checkbox" name="sync_quota_ids[]"
                                        value="<?php echo e($quota->id); ?>" <?php echo e(in_array($quota->id, $linkedIds) ? 'checked' : ''); ?>>
                                    <?php echo e($quota->university_name_tr); ?> (مفاضلة
                                <?php echo e($quota->competition_number); ?>)</label><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                            </div>
                        </div>
...
<div class="col-span-1 md:col-span-2">
    ...
    <div class="grid grid-cols-2 gap-2 border rounded-lg p-4 bg-gray-50 max-h-60 overflow-y-auto">
        <?php $unmatchedPostgraduateQuotas = \App\Models\PostgraduateQuota::whereNull('university_id')->get(); ?>
        <?php $__empty_1 = true; $__currentLoopData = $unmatchedPostgraduateQuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
            <label class="flex items-center gap-2 cursor-pointer hover:bg-gray-100 p-1 rounded">
                <input type="checkbox" name="sync_postgraduate_quota_ids[]" value="<?php echo e($quota->id); ?>"
                    class="rounded border-gray-300 text-yellow-500">
                <span class="text-sm text-gray-700"><?php echo e($quota->university_name_tr); ?> (مفاضلة <?php echo e($quota->competition_number); ?>)</span>
            </label>
        ...
        <?php endif; ?>
                        ...
                        <div><label class="block font-semibold mb-2">🎥 رابط الفيديو (YouTube)</label><input type="url"
                                name="video_url" value="<?php echo e(old('video_url', $university->video_url)); ?>"
                                class="w-full px-4 py-2 border-2 rounded-lg"></div>
                        <div><label class="block font-semibold mb-2">📊 الترتيب المحلي</label><input type="number"
                                name="rank_local" value="<?php echo e(old('rank_local', $university->rank_local)); ?>"
                                class="w-full px-4 py-2 border-2 rounded-lg"></div>
                        <div><label class="block font-semibold mb-2">🌍 الترتيب العالمي</label><input type="number"
                                name="rank_global" value="<?php echo e(old('rank_global', $university->rank_global)); ?>"
                                class="w-full px-4 py-2 border-2 rounded-lg"></div>
                        <div><label class="block font-semibold mb-2">🖼️ شعار الجامعة</label><input type="file"
                                name="logo" class="w-full px-4 py-2 border-2 rounded-lg"><?php if($university->logo): ?>
                                    <div class="mt-2"><img src="<?php echo e(Storage::url($university->logo)); ?>"  loading="lazy"
                                class="w-16 h-16 object-cover rounded"></div><?php endif; ?>
                        </div>
                        <div class="mt-4">
...
<div class="col-span-1 md:col-span-2 mt-4 pt-4 border-t border-gray-200">
    <div class="flex items-center justify-between bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl p-4 border border-green-200">
        ...
        <a href="<?php echo e(route('admin.universities.recognitions', $university->id)); ?>" 
...
<div class="col-span-1 md:col-span-2">
                ...
                <div class="flex flex-wrap gap-3" id="existingGallery">
                    <?php $__currentLoopData = $existingImages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $image): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="relative group w-24 h-24 rounded-lg overflow-hidden shadow-md border-2 border-gray-200">
                            <img src="<?php echo e(asset('storage/' . $image)); ?>"  loading="lazy" class="w-full h-full object-cover">
                            <button type="button" onclick="removeExistingImage(this, '<?php echo e($image); ?>')" 
    ...
    <?php endif; ?>
                    ...
                    <div class="mt-6"><label class="block font-semibold mb-2">📝 وصف الجامعة</label><textarea
                            ...
                            class="w-full px-4 py-2 border-2 rounded-lg"><?php echo e(old('description', $university->description)); ?></textarea>
                    </div>
                    ...
                    <div class="flex gap-4 mt-8"><button type="submit"
                            ...
                            التغييرات</button><a href="<?php echo e(route('admin.universities.index')); ?>"
    ...
    <div class="border rounded-lg p-4 bg-gray-50" data-id="<?php echo e($college->id); ?>">
        <div class="flex justify-between items-center mb-2 gap-2">
            <input type="text" class="college-name border rounded px-2 py-1 flex-1"
                value="<?php echo e($college->name_ar); ?>" placeholder="اسم الكلية">
            <input type="number" class="college-fee border rounded px-2 py-1 w-32"
                value="<?php echo e($college->pivot->fee ?? ''); ?>" placeholder="القسط">
            
            <!-- ✅ أضف هذا -->
            <select class="college-language border rounded px-2 py-1 w-32">
    <option value="">اللغة</option>
    <option value="turkish" <?php echo e(($college->pivot->language ?? '') == 'turkish' ? 'selected' : ''); ?>>🇹🇷 تركي</option>
    <option value="english" <?php echo e(($college->pivot->language ?? '') == 'english' ? 'selected' : ''); ?>>🇬🇧 إنجليزي</option>
    <option value="arabic" <?php echo e(($college->pivot->language ?? '') == 'arabic' ? 'selected' : ''); ?>>🇸🇦 عربي</option>
    <option value="russian" <?php echo e(($college->pivot->language ?? '') == 'russian' ? 'selected' : ''); ?>>🇷🇺 روسي</option>
    <option value="chinese" <?php echo e(($college->pivot->language ?? '') == 'chinese' ? 'selected' : ''); ?>>🇨🇳 صيني</option>
</select>
                            ...
                            <div class="mr-6">
                                <div class="flex gap-2 mb-2">
                                    <select class="major-select border rounded px-2 py-1 flex-1">
                                        ...
                                        <?php $__currentLoopData = $majors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $major): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><option value="<?php echo e($major->id); ?>"><?php echo e($major->name_ar); ?>
                                ...
                                <div class="majors-list space-y-1">
                                    <?php $__currentLoopData = $college->majors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $major): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><div
                                        class="flex justify-between bg-white p-2 rounded" data-major-id="<?php echo e($major->id); ?>">
                                        <span><?php echo e($major->name_ar); ?></span><button
                                            onclick="removeMajorFromCollege(this, <?php echo e($college->id); ?>, <?php echo e($major->id); ?>)"
                                    class="text-red-500 text-sm">حذف</button></div><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    ...
    <div class="border rounded-lg p-4 bg-gray-50" data-id="<?php echo e($institute->id); ?>">
        <div class="flex justify-between items-center mb-2 gap-2">
            <input type="text" class="institute-name border rounded px-2 py-1 flex-1"
                value="<?php echo e($institute->name_ar); ?>" placeholder="اسم المعهد">
            <input type="number" class="institute-fee border rounded px-2 py-1 w-32"
                value="<?php echo e($institute->pivot->fee ?? ''); ?>" placeholder="القسط">
            
            <!-- ✅ أضف هذا -->
            <select class="institute-language border rounded px-2 py-1 w-32">
    <option value="">اللغة</option>
    <option value="turkish" <?php echo e(($institute->pivot->language ?? '') == 'turkish' ? 'selected' : ''); ?>>🇹🇷 تركي</option>
    <option value="english" <?php echo e(($institute->pivot->language ?? '') == 'english' ? 'selected' : ''); ?>>🇬🇧 إنجليزي</option>
    <option value="arabic" <?php echo e(($institute->pivot->language ?? '') == 'arabic' ? 'selected' : ''); ?>>🇸🇦 عربي</option>
    <option value="russian" <?php echo e(($institute->pivot->language ?? '') == 'russian' ? 'selected' : ''); ?>>🇷🇺 روسي</option>
    <option value="chinese" <?php echo e(($institute->pivot->language ?? '') == 'chinese' ? 'selected' : ''); ?>>🇨🇳 صيني</option>
</select>
            ...
            <button onclick="deleteInstitute(this)" class="text-red-500 hover:text-red-700 px-2">🗑️</button>
                            ...
                            <div class="mr-6">
                                ...
                                <div class="institute-majors-list space-y-1">
                                    <?php $__currentLoopData = $institute->majors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $major): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?><div
                                        class="flex justify-between bg-white p-2 rounded" data-major-id="<?php echo e($major->id); ?>">
                                        <span><?php echo e($major->name_ar); ?></span><button
                                            onclick="removeMajorFromInstitute(this, <?php echo e($institute->id); ?>, <?php echo e($major->id); ?>)"
                                    class="text-red-500 text-sm">حذف</button></div><?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                </div>
                            </div>
                        </div>
...
<div id="programsTab" class="p-6 hidden">
    ...
    <div id="programsList" class="space-y-4 max-h-96 overflow-y-auto p-2">
        <?php $__currentLoopData = $university->programs; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div class="border rounded-lg p-4 bg-gray-50 program-item" data-id="<?php echo e($program->id); ?>">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-3">
                    <div>
                        ...
                        <input type="text" class="program-name-ar border rounded px-3 py-2 w-full" 
                               value="<?php echo e($program->program_name_ar); ?>" placeholder="مثال: إدارة الأعمال">
                    </div>
                    <div>
                        ...
                        <input type="text" class="program-name-tr border rounded px-3 py-2 w-full" 
                               value="<?php echo e($program->program_name_tr); ?>" placeholder="مثال: İşletme">
                    </div>
                    <div>
                        ...
                        <select class="program-level border rounded px-3 py-2 w-full">
                            <option value="bachelor" <?php echo e($program->level == 'bachelor' ? 'selected' : ''); ?>>🎓 بكالوريوس</option>
                            <option value="master" <?php echo e($program->level == 'master' ? 'selected' : ''); ?>>📖 ماجستير</option>
                            <option value="phd" <?php echo e($program->level == 'phd' ? 'selected' : ''); ?>>📚 دكتوراه</option>
                            <option value="diploma" <?php echo e($program->level == 'diploma' ? 'selected' : ''); ?>>📜 دبلوم</option>
                        </select>
                    </div>
                </div>
                <div class="grid grid-cols-1 md:grid-cols-4 gap-3 mb-3">
                    <div>
                        ...
                        <select class="program-language border rounded px-3 py-2 w-full">
                            ...
                            <option value="turkish" <?php echo e($program->language == 'turkish' ? 'selected' : ''); ?>>🇹🇷 تركي</option>
                            <option value="english" <?php echo e($program->language == 'english' ? 'selected' : ''); ?>>🇬🇧 إنجليزي</option>
                            <option value="arabic" <?php echo e($program->language == 'arabic' ? 'selected' : ''); ?>>🇸🇦 عربي</option>
                            <option value="russian" <?php echo e($program->language == 'russian' ? 'selected' : ''); ?>>🇷🇺 روسي</option>
                        </select>
                    </div>
                    <div>
                        ...
                        <input type="number" class="program-fee border rounded px-3 py-2 w-full" 
                               value="<?php echo e($program->fee); ?>" placeholder="مثال: 5000" step="0.01">
                    </div>
                    <div>
                        ...
                        <input type="number" class="program-duration border rounded px-3 py-2 w-full" 
                               value="<?php echo e($program->duration); ?>" placeholder="مثال: 4" step="1">
                    </div>
                    <div class="flex items-end">
                        ...
                        <button type="button" onclick="deleteProgram(this, <?php echo e($program->id); ?>)" 
                ...
                <div>
                    ...
                    <textarea class="program-description border rounded px-3 py-2 w-full" rows="2" 
                              placeholder="وصف مختصر للبرنامج..."><?php echo e($program->description); ?></textarea>
                </div>
            </div>
        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
    </div>
...
document.getElementById('universityForm').addEventListener('submit', function(e) {
    ...
    let currentUniversityId = <?php echo e($university->id); ?>;
  ...
  function showTab(tab) {
   ...
   function addCollegeWithName(name = '') {
    ...
    <?php $__currentLoopData = $majors; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $major): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
        majorOptions += '<option value="<?php echo e($major->id); ?>"><?php echo e($major->name_ar); ?></option>';
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
</html><?php /**PATH C:\laragon\www\testProject\resources\views/admin/universities/edit.blade.php ENDPATH**/ ?>