    ...
    <div class="container mx-auto px-4 py-10 max-w-6xl">
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div id="basicTab" class="p-6">
                <form action="<?php echo e(route('admin.universities.store')); ?>" method="POST" enctype="multipart/form-data"
                    id="universityForm">
                    <?php echo csrf_field(); ?>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input type="text" name="name_tr" value="<?php echo e(old('name_tr')); ?>" required
                                class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-yellow-500 focus:outline-none">
                        </div>
                        <div>
                        ...
                        <div>
                            ...
                            <select name="type" required
                                ...
                                <option value="public" <?php echo e(old('type') == 'public' ? 'selected' : ''); ?>>🏢 حكومية</option>
                                <option value="private" <?php echo e(old('type') == 'private' ? 'selected' : ''); ?>>🏛️ خاصة</option>
                            </select>
                        </div>
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2">📅 تاريخ التأسيس</label>
                            <input type="text" name="established_date" value="<?php echo e(old('established_date')); ?>"
                        ...
                        <div class="col-span-1 md:col-span-2">
                            ...
                            <div
                                ...
                                <?php $unmatchedQuotas = \App\Models\UniversityQuota::whereNull('university_id')->get(); ?>
                                <?php $__empty_1 = true; $__currentLoopData = $unmatchedQuotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $quota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <label class="flex items-center gap-2 cursor-pointer hover:bg-gray-100 p-1 rounded">
                                        <input type="checkbox" name="sync_quota_ids[]" value="<?php echo e($quota->id); ?>"
                                            class="rounded border-gray-300 text-yellow-500">
                                        <span class="text-sm text-gray-700"><?php echo e($quota->university_name_tr); ?> (مفاضلة
                                            <?php echo e($quota->competition_number); ?>)</span>
                                    </label>
                        ...
                        <div>
                            ...
                            <input type="number" name="rank_local" value="<?php echo e(old('rank_local')); ?>"
                                class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-yellow-500 focus:outline-none">
                        </div>
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2">🌍 الترتيب العالمي</label>
                            <input type="number" name="rank_global" value="<?php echo e(old('rank_global')); ?>"
                                class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-yellow-500 focus:outline-none">
                        </div>
                        <div>
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="description" rows="5"
                            class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg focus:border-yellow-500 focus:outline-none"><?php echo e(old('description')); ?></textarea>
                    </div>
...
</html><?php /**PATH C:\laragon\www\testProject\resources\views/admin/universities/create.blade.php ENDPATH**/ ?>