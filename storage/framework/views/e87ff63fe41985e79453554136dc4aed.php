...
<head>
    ...
    <meta name="description" content="<?php echo e(__('messages.universities_page_subtitle')); ?>">
    <meta name="keywords" content="<?php echo e(__('messages.all_universities_short')); ?>">
    <meta property="og:title" content="<?php echo e(__('messages.universities_page_title')); ?>">
    <meta property="og:description" content="<?php echo e(__('messages.universities_page_subtitle')); ?>">
    <title><?php echo e(__('messages.universities_page_title')); ?> - <?php echo e(config('app.name')); ?></title>
...
<?php endif; ?>
    ...
    <div class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 py-16 mt-20">
        <div class="container mx-auto px-4 text-center">
            <h1 class="text-4xl md:text-5xl font-bold text-white mb-4"><?php echo e(__('messages.universities_page_title')); ?></h1>
            <p class="text-gray-300 text-lg"><?php echo e(__('messages.universities_page_subtitle')); ?></p>
        </div>
    </div>
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="bg-white rounded-2xl shadow-xl p-6 md:p-8 mb-12 border border-gray-100">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 flex items-center gap-2">
                    ...
                    <?php echo e(__('messages.search_filter_advanced')); ?>
                ...
                <form action="<?php echo e(route('universities.index')); ?>" method="GET" id="filterForm">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-6">
                        ...
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2 text-sm">🏫
                                <?php echo e(__('messages.university_name')); ?></label>
                            <input type="text" name="search" value="<?php echo e(request('search')); ?>"
                                placeholder="<?php echo e(__('messages.university_name')); ?>"
                        ...
                        <!-- نوع الجامعة -->
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2 text-sm">🏷️
                                <?php echo e(__('messages.type_university')); ?></label>
                            <select name="type"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 focus:outline-none transition">
                                <option value=""><?php echo e(__('messages.all')); ?></option>
                                <option value="public" <?php echo e(request('type') == 'public' ? 'selected' : ''); ?>>🏛️
                                    <?php echo e(__('messages.public')); ?>

                                </option>
                                <option value="private" <?php echo e(request('type') == 'private' ? 'selected' : ''); ?>>🏢
                        ...
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2 text-sm">📍
                                <?php echo e(__('messages.city')); ?></label>
                            <input type="text" name="city" value="<?php echo e(request('city')); ?>"
                                placeholder="<?php echo e(__('messages.city')); ?>" list="citySuggestions"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 focus:outline-none transition">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
                        ...
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2 text-sm">🌐
                                <?php echo e(__('messages.study_language')); ?></label>
                            <div
                                ...
                                <label
                                    ...
                                    <input type="checkbox" name="language[]" value="russian" <?php echo e(in_array('russian', (array) request('language', [])) ? 'checked' : ''); ?>
                                        ...
                                        class="rounded border-gray-300 text-yellow-500">
                                    <span class="text-sm">🇦🇲 Հայերեն</span>
                                </label>
                            </div>
                        </div>
                        ...
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2 text-sm">🎓
                                <?php echo e(__('messages.college')); ?></label>
                            <input type="text" name="college" value="<?php echo e(request('college')); ?>"
                                placeholder="<?php echo e(__('messages.college')); ?>" list="collegeSuggestions"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 focus:outline-none transition">
                        ...
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2 text-sm">📚
                                <?php echo e(__('messages.institute')); ?></label>
                            <input type="text" name="institute" value="<?php echo e(request('institute')); ?>"
                                placeholder="<?php echo e(__('messages.institute')); ?>" list="instituteSuggestions"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 focus:outline-none transition">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5 mb-8">
                        ...
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2 text-sm">📊
                                <?php echo e(__('messages.sort_by')); ?></label>
                            <select name="sort"
                                class="w-full px-4 py-2.5 border border-gray-300 rounded-xl focus:border-yellow-500 focus:ring-2 focus:ring-yellow-200 focus:outline-none transition">
                                <option value="rank_local" <?php echo e(request('sort') == 'rank_local' ? 'selected' : ''); ?>>📈
                                    <?php echo e(__('messages.rank_local')); ?>
                        ...
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2 text-sm">🔢
                                <?php echo e(__('messages.results_count')); ?></label>
                            <select name="per_page"
                                ...
                                <option value="all" <?php echo e(request('per_page') == 'all' ? 'selected' : ''); ?>>
                                    <?php echo e(__('messages.all_universities_short')); ?>
                                ...
                                <div class="flex gap-2 mt-2">
                                    ...
                                    <?php if($university->website): ?>
                                        <a href="<?php echo e($university->website); ?>" target="_blank"
                                            ...
                                            <?php echo e(__('messages.website')); ?>
            ...
            <?php else: ?>
                ...
                <div class="bg-white rounded-lg shadow-lg p-12 text-center">
                    ...
                    <h3 class="text-2xl font-bold text-gray-800 mb-2"><?php echo e(__('messages.no_universities_found')); ?></h3>
                    <p class="text-gray-600 mb-6"><?php echo e(__('messages.try_changing_criteria')); ?></p>
                    <a href="<?php echo e(route('universities.index')); ?>"
...
</html><?php /**PATH C:\laragon\www\testproject-main\resources\views/universities/index.blade.php ENDPATH**/ ?>