            ...
            <div class="p-6">
                <form action="<?php echo e(route('admin.articles.store')); ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="grid grid-cols-1 gap-6">
                        ...
                        <!-- صورة المقال -->
                        <div>
                            <label class="block text-gray-700 font-semibold mb-2">صورة المقال (اختياري)</label>
                            <input type="file" name="image" accept="image/*"
                                class="w-full px-4 py-2 border-2 border-gray-200 rounded-lg">
                            <p class="text-xs text-gray-400 mt-1">الصيغ المدعومة: JPG, PNG, GIF (حد أقصى 2MB)</p>
                        </div>

                        <!-- النشر -->
                        <div class="flex items-center gap-2">
                            <input type="checkbox" name="is_published" id="is_published" value="1" class="w-5 h-5">
                    ...
                    <div class="mt-6">
                        ...
                        <textarea name="content" id="content" rows="15" required
                            class="w-full px-4 py-3 border-x-2 border-b-2 border-gray-200 rounded-b-lg focus:border-yellow-500 focus:outline-none"><?php echo e(old('content')); ?></textarea>
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\testProject\resources\views/admin/articles/create.blade.php ENDPATH**/ ?>