...
<?php $__env->startSection('content'); ?>
    <div class="container mx-auto px-4 py-8 max-w-2xl">
        ...
        <form action="<?php echo e(route('admin.announcements.store')); ?>" method="POST" enctype="multipart/form-data"
            ...
            <div class="mb-4">
                ...
                <div id="imagePreview" class="hidden mb-3">
                    <img id="previewImg"
                        src="<?php echo e(isset($announcement) && $announcement->image ? asset('storage/' . $announcement->image) : '#'); ?>"
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\testProject\resources\views/admin/announcements/create.blade.php ENDPATH**/ ?>