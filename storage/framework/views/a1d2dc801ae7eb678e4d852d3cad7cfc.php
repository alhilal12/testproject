...
<head>
    ...
    <title><?php echo e(__('messages.register')); ?> - <?php echo e(config('app.name')); ?></title>
        ...
        <div class="container mx-auto px-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="text-xl font-bold text-gray-800"><?php echo e(config('app.name')); ?></span>
                </div>
                <a href="<?php echo e(route('login')); ?>" class="text-gray-600 hover:text-yellow-600 transition"><?php echo e(__('messages.login')); ?></a>
            </div>
        </div>
    </nav>
    ...
    <div class="min-h-screen flex items-center justify-center py-12 px-4">
        <div class="max-w-md w-full bg-white rounded-2xl shadow-xl overflow-hidden animate-fadeUp">
            ...
            <div class="bg-gradient-to-r from-yellow-500 to-yellow-600 px-8 py-6 text-center">
                <h1 class="text-2xl font-bold text-white mb-1"><?php echo e(__('messages.register')); ?></h1>
                <p class="text-yellow-100 text-sm">انضم إلينا وابدأ رحلتك الأكاديمية</p>
            </div>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="input-group relative">
                        <input type="password" id="password_confirmation" name="password_confirmation" placeholder=" "
                            required class="w-full pl-10">
                        <label for="password_confirmation"><?php echo e(__('Confirm Password')); ?></label>
                        <button type="button" onclick="togglePassword('password_confirmation')"
                            class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-yellow-600 transition">
                            <svg id="eyeIcon-password_confirmation" class="w-5 h-5" fill="none" stroke="currentColor"
                                viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                    d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    ...
                    <!-- Submit Button -->
                    <button type="submit"
                        class="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 hover:from-yellow-600 hover:to-yellow-700 text-white font-bold py-3 rounded-xl transition-all duration-300 transform hover:scale-[1.02] active:scale-100 shadow-md mt-6">
    ...
    <script>
        ...
        form.addEventListener('submit', function (e) {
            if (password.value !== confirm.value) {
                ...
                setTimeout(() => confirm.classList.remove('error-shake'), 300);
            }
        });
    </script>
</body>

</html><?php /**PATH C:\laragon\www\testproject-main\resources\views/auth/register.blade.php ENDPATH**/ ?>