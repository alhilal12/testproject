...
<?php endif; ?>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden">
            ...
            <div class="p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <?php $__currentLoopData = $docTypes; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $doc): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <?php
                        ...
                        <div class="border rounded-xl p-4 hover:shadow-md transition">
                            <div class="flex justify-between items-start">
                                <div>
                                    <div class="text-3xl mb-2"><?php echo e($doc['icon']); ?></div>
                                    <h3 class="font-bold text-gray-800"><?php echo e($doc['name']); ?></h3>
                                    <?php if($doc['required']): ?>
                                ...
                                <?php if($existingDoc): ?>
                                    <div class="text-right">
                                        ...
                                        <button onclick="deleteDocument(<?php echo e($existingDoc->id); ?>)" class="block text-red-500 text-xs mt-1">حذف</button>
                                    </div>
                                <?php else: ?>
                                    <button onclick="uploadDocument('<?php echo e($key); ?>')" class="bg-yellow-500 hover:bg-yellow-600 text-white px-4 py-2 rounded-lg text-sm transition">
                                        رفع الملف
                                    </button>
                                <?php endif; ?>
                            </div>
                            <?php if($existingDoc): ?>
                                <div class="mt-3 pt-3 border-t border-gray-100">
                                    <a href="<?php echo e(asset('storage/' . $existingDoc->file_path)); ?>" target="_blank" class="text-blue-500 text-sm hover:underline">
                                        عرض الملف المرفوع
                                    </a>
                                </div>
                            <?php endif; ?>
    ...
    <script>
        ...
        document.getElementById('uploadForm').addEventListener('submit', function(e) {
            ...
            fetch('<?php echo e(route("documents.upload")); ?>', {
                method: 'POST',
...
</html><?php /**PATH C:\laragon\www\testProject\resources\views/documents/index.blade.php ENDPATH**/ ?>