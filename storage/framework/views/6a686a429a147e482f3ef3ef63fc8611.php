...
<head>
    ...
    <title><?php echo e($title ?? __('messages.university_quotas')); ?> | الهلال للاستشارات التعليمية</title> 
...
<?php endif; ?>
    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <div class="flex justify-center gap-4 mb-8">
            <a href="<?php echo e(route('university-quotas.index', ['type' => 'undergraduate'])); ?>"
                ...
                📊 <?php echo e(__('messages.undergraduate')); ?>
            ...
            <a href="<?php echo e(route('university-quotas.index', ['type' => 'postgraduate'])); ?>"
                ...
                🎓 <?php echo e(__('messages.postgraduate')); ?>
            ...
            <form method="GET" action="<?php echo e(route('university-quotas.index')); ?>" id="filterForm">
                ...
                <div class="flex flex-wrap gap-4 items-end">
                    ...
                    <div class="flex-1 min-w-[200px]">
                        <label class="block text-sm font-semibold text-gray-700 mb-1">🔍 <?php echo e(__('messages.search')); ?></label>
                        <input type="text" name="search" value="<?php echo e(request('search')); ?>" placeholder="<?php echo e(__('messages.search_university')); ?>"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-yellow-500 focus:outline-none">
                    </div>

                    <!-- فلترة المدينة -->
                    <div class="w-48">
                        <label class="block text-sm font-semibold text-gray-700 mb-1"><?php echo e(__('messages.city')); ?></label>
                        <select name="city"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-yellow-500 focus:outline-none">
                            <option value="all"></option><?php echo e(__('messages.all_cities')); ?></option>
                    ...
                    <?php if($viewType == 'undergraduate'): ?>
                        <div class="w-56">
                            <label class="block text-sm font-semibold text-gray-700 mb-1">🏛️ <?php echo e(__('messages.college')); ?></label>
                            <select name="college"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-yellow-500 focus:outline-none">
                                <option value=""><?php echo e(__('messages.all_colleges')); ?></option>
                        ...
                        <div class="w-56">
                            <label class="block text-sm font-semibold text-gray-700 mb-1">📚 <?php echo e(__('messages.institute')); ?></label>
                            <select name="institute"
                                class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:border-yellow-500 focus:outline-none">
                                <option value=""><?php echo e(__('messages.all_institutes')); ?></option>
                    ...
                    <div class="flex items-center h-[50px]">
                        <label class="flex items-center gap-2 cursor-pointer">
                            ...
                            <span class="text-sm text-gray-700">📅 <?php echo e(__('messages.hide_expired')); ?></span>
                        </label>
                    </div>
                ...
                <table class="w-full text-right border-collapse">
                    <thead>
                        <tr class="table-header text-white">
                            ...
                            <th class="px-4 py-3 text-right"><?php echo e(__('messages.university_name')); ?></th>
                            <th class="px-4 py-3 text-right"><?php echo e(__('messages.university_name_ar')); ?></th>

                            
                            <?php if($viewType == 'postgraduate'): ?>
                                <th class="px-4 py-3 text-right"><?php echo e(__('messages.program_or_institute')); ?></th>
                            <?php endif; ?>

                            <th class="px-4 py-3 text-center"><?php echo e(__('messages.tuition_fees')); ?></th>
                            <th class="px-4 py-3 text-center"><?php echo e(__('messages.city')); ?></th>
                            <th class="px-4 py-3 text-center"><?php echo e(__('messages.registration_start')); ?></th>
                            <th class="px-4 py-3 text-center"><?php echo e(__('messages.registration_end')); ?></th>
                            <th class="px-4 py-3 text-center"><?php echo e(__('messages.results')); ?></th>
                            <th class="px-4 py-3"><?php echo e(__('messages.accepted_certificates')); ?></th>
                            <th class="px-4 py-3 text-center"><?php echo e(__('messages.details')); ?></th>
                            <th class="px-4 py-3 text-center"><?php echo e(__('messages.application_type')); ?></th>
                            <th class="px-4 py-3 text-center"><?php echo e(__('messages.local_ranking')); ?></th>
                        </tr>
                    </thead>
                    <tbody>
                        ...
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                            <tr>
                                <td colspan="<?php echo e($viewType == 'postgraduate' ? 12 : 11); ?>"
                                    ...
                                    <div class="text-lg">📭 ل<?php echo e(__('messages.zerodata')); ?></div>
        ...
        <div class="text-center text-sm text-gray-400 mt-6">
             <?php echo e(__('messages.update_info')); ?>
    ...
    <div id="detailsModal" class="fixed inset-0 bg-black/50 hidden items-center justify-center z-50">
        <div class="bg-white rounded-xl max-w-md w-full mx-4 p-6">
            <div class="flex justify-between items-center mb-4">
                <h3 class="text-xl font-bold text-gray-800"> <?php echo e(__('messages.details')); ?></h3>
    ...
    <footer class="bg-gray-900 text-white py-8 mt-12">
        <div class="container mx-auto px-4 text-center">
            <p>&copy; <?php echo e(date('Y')); ?> <?php echo e(__('messages.copyright')); ?></p>
        </div>
    </footer>
...
<?php /**PATH C:\laragon\www\testproject-main\resources\views/university-quotas/index.blade.php ENDPATH**/ ?>