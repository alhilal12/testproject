...
<head>
    ...
    <title><?php echo e(__('messages.articles_knowledge')); ?> | <?php echo e(config('app.name')); ?></title>
...
<?php endif; ?>
    ...
    <main class="max-w-[1200px] mx-auto px-6 mt-12">
        ...
        <div class="text-center mb-16">
            <h1 class="text-4xl md:text-5xl font-bold text-gray-800 mb-4 tracking-tight">📚 <?php echo e(__('messages.articles_knowledge')); ?></h1>
            <p class="text-lg text-gray-600 max-w-2xl mx-auto leading-relaxed">
                <?php echo e(__('messages.articles_subtitle')); ?>
        ...
        <div class="flex flex-col md:flex-row gap-6 mb-12 items-center justify-between">
            <div class="relative w-full md:max-w-md">
                ...
                <input type="text" id="searchInput" onkeyup="filterArticles()"
                    ...
                    placeholder="<?php echo e(__('messages.search_articles')); ?>">
            </div>
            <div class="flex gap-3 overflow-x-auto pb-2 md:pb-0 w-full md:w-auto">
                <button onclick="filterByCategory('all')" id="cat-all"
                    class="category-btn bg-yellow-500 text-white px-6 py-2 rounded-full font-medium text-sm shadow-md"><?php echo e(__('messages.all_articles')); ?></button>
                <button onclick="filterByCategory('turkey-studies')" id="cat-turkey-studies"
                    class="category-btn bg-gray-100 text-gray-600 px-6 py-2 rounded-full font-medium text-sm hover:bg-yellow-500 hover:text-white transition-all"><?php echo e(__('messages.study_in_turkey')); ?></button>
                <button onclick="filterByCategory('exams')" id="cat-exams"
                    class="category-btn bg-gray-100 text-gray-600 px-6 py-2 rounded-full font-medium text-sm hover:bg-yellow-500 hover:text-white transition-all"><?php echo e(__('messages.exams')); ?></button>
                <button onclick="filterByCategory('scholarships')" id="cat-scholarships"
                    class="category-btn bg-gray-100 text-gray-600 px-6 py-2 rounded-full font-medium text-sm hover:bg-yellow-500 hover:text-white transition-all"><?php echo e(__('messages.scholarships')); ?></button>
                <button onclick="filterByCategory('certificates')" id="cat-certificates"
                    class="category-btn bg-gray-100 text-gray-600 px-6 py-2 rounded-full font-medium text-sm hover:bg-yellow-500 hover:text-white transition-all"><?php echo e(__('messages.certificates')); ?></button>
                <button onclick="filterByCategory('testimonials')" id="cat-testimonials"
                    class="category-btn bg-gray-100 text-gray-600 px-6 py-2 rounded-full font-medium text-sm hover:bg-yellow-500 hover:text-white transition-all"><?php echo e(__('messages.testimonials')); ?></button>
            </div>
        </div>
                ...
                <article
                    ...
                    <div class="p-5">
                        <div class="flex items-center justify-between text-sm text-gray-400 mb-3">
                            ...
                            <span><?php echo e($article->read_time ?? '4'); ?> <?php echo e(__('messages.read_time')); ?></span>
                        </div>
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <a href="<?php echo e(route('articles.show', $article->slug)); ?>"
                                ...
                                <?php echo e(__('messages.read_more_short')); ?>
        ...
        <?php if($articles->count() == 0): ?>
            <div class="text-center py-16">
                ...
                <p class="text-gray-500 text-lg"><?php echo e(__('messages.no_articles')); ?></p>
                <p class="text-gray-400 text-sm mt-2"><?php echo e(__('messages.coming_soon')); ?></p>
            </div>
        <?php endif; ?>
        ...
        <div class="mt-16 bg-gradient-to-r from-gray-800 to-gray-900 rounded-2xl p-8 md:p-12 text-center text-white">
            ...
            <h3 class="text-2xl font-bold mb-2"><?php echo e(__('messages.newsletter_title')); ?></h3>
            <p class="text-gray-300 mb-6 max-w-md mx-auto"><?php echo e(__('messages.newsletter_subtitle')); ?></p>
            <form class="max-w-md mx-auto flex flex-col sm:flex-row gap-3">
                <input type="email" placeholder="<?php echo e(__('messages.email_placeholder')); ?>"
                    class="flex-1 px-4 py-2 rounded-lg text-gray-800 focus:outline-none focus:ring-2 focus:ring-yellow-500">
                <button type="submit"
                    class="bg-yellow-500 hover:bg-yellow-600 text-white font-bold px-6 py-2 rounded-lg transition"><?php echo e(__('messages.subscribe')); ?></button>
            </form>
        </div>
    </main>
...
</html><?php /**PATH C:\laragon\www\testproject-main\resources\views/articles/index.blade.php ENDPATH**/ ?>