...
$__newAttributes = [];
$__propNames = \Illuminate\View\ComponentAttributeBag::extractPropNames((['universities' => [], 'title' => 'استكشف الجامعات التركية', 'subtitle' => 'اختر من بين أفضل الجامعات الحكومية والخاصة', 'showViewAllButton' => false]));
...
foreach (array_filter((['universities' => [], 'title' => 'استكشف الجامعات التركية', 'subtitle' => 'اختر من بين أفضل الجامعات الحكومية والخاصة', 'showViewAllButton' => false]), 'is_string', ARRAY_FILTER_USE_KEY) as $__key => $__value) {
    $$__key = $$__key ?? $__value;
}
     ...
     class="w-full h-full object-cover group-hover:scale-110 transition duration-300">
                                    <?php else: ?>
                                        <div class="w-full h-full bg-gradient-to-br from-yellow-400 to-yellow-500 flex items-center justify-center">
                                            <span class="text-white text-xl font-bold"><?php echo e(mb_substr($university->name_ar, 0, 2)); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                                ...
                                <div class="absolute -bottom-3 left-1/2 transform -translate-x-1/2 whitespace-nowrap">
                                    <span class="px-2 py-0.5 rounded-full text-white text-xs font-bold shadow-md <?php echo e($university->type == 'public' ? 'bg-blue-500' : 'bg-purple-500'); ?>">
                            ...
                            <?php if(is_array($langs) && count($langs) > 0): ?>
                                <div class="flex justify-center gap-1 mb-3">
                                    <?php $__currentLoopData = array_slice($langs, 0, 4); $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $lang): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <span class="text-xs bg-gray-100 rounded-full px-2 py-0.5"><?php echo e($langMap[$lang] ?? substr($lang, 0, 2)); ?></span>
...
</style><?php /**PATH C:\Users\DELL\Desktop\testproject-master\testproject-master\resources\views/components/universities-cards-section.blade.php ENDPATH**/ ?>