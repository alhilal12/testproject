...
<?php endif; ?>
    ...
    <div class="bg-gradient-to-r from-gray-900 via-gray-800 to-gray-900 py-10 mt-20">
        <div class="container mx-auto px-4">
            ...
            <p class="text-gray-300 animate-fadeUp" style="animation-delay: 0.1s;">مرحباً <?php echo e(Auth::user()->name); ?>،
    ...
    <div class="container mx-auto px-4 py-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-5 gap-4 mb-8 animate-fadeUp">
            ...
            <div class="stat-card rounded-xl shadow-md p-4 text-center border-t-4 border-purple-500">
                <p class="text-2xl font-bold text-purple-600"><?php echo e($stats['today']); ?></p>
        ...
        <div class="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8 animate-fadeUp">
            ...
            <a href="<?php echo e(route('consultant.students-documents')); ?>"
                class="flex items-center justify-center gap-2 p-3 bg-white rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <a href="<?php echo e(route('consultant.reports')); ?>"
                class="flex items-center justify-center gap-2 p-3 bg-white rounded-xl shadow-md hover:shadow-lg transition">
            ...
            <a href="<?php echo e(route('consultant.contact.config')); ?>"
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden animate-fadeUp">
                        ...
                        <table class="w-full">
                            thead<thead>
                                <tr class="bg-gray-50 border-b">
                                    ...
                                    <th class="text-right py-3 px-4">المرفق</th> 
                            ...
                            <tbody>
                                <?php $__currentLoopData = $consultations; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $consult): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4"><?php echo e($consult->id); ?></td>
                                        <td class="py-3 px-4"><?php echo e($consult->student->name); ?></td>
                                        <td class="py-3 px-4 max-w-xs truncate"><?php echo e($consult->message); ?></td>
                                        <td class="py-3 px-4">
                                            <?php if($consult->attachment): ?>
                                                <a href="<?php echo e(asset('storage/' . $consult->attachment)); ?>" target="_blank"
                                        ...
                                        <td class="py-3 px-4"><?php echo e($consult->created_at->format('Y/m/d')); ?></td>
                                        <td class="py-3 px-4">
                                        ...
                                        <td class="py-3 px-4">
                                            <a href="<?php echo e(route('consultant.reply.form', $consult->id)); ?>"
            ...
            <div id="messagesTab" class="p-6 hidden">
                <?php if($contactMessages->count() > 0): ?>
                        ...
                        <table class="w-full">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $contactMessages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr class="border-b hover:bg-gray-50">
                                        <td class="py-3 px-4"><?php echo e($message->id); ?></td>
                                        <td class="py-3 px-4">
                                        ...
                                        <td class="py-3 px-4"><?php echo e($message->email); ?></td>
                                        <td class="py-3 px-4 max-w-xs truncate"><?php echo e($message->message); ?></td>
                                        <td class="py-3 px-4"><?php echo e($message->created_at->format('Y/m/d')); ?></td>
                                        <td class="py-3 px-4">
                    ...
                    <div class="mt-6">
                        <?php echo e($contactMessages->links()); ?>
...
</html><?php /**PATH C:\laragon\www\testproject-main\resources\views/consultant/dashboard.blade.php ENDPATH**/ ?>