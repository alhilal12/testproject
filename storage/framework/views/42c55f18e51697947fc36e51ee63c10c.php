...
<?php endif; ?>
                ...
                <div class="flex-1 text-center md:text-right">
                    ...
                    <div class="flex flex-wrap gap-3 justify-center md:justify-start">
                        <span class="px-4 py-1.5 bg-yellow-500 text-white rounded-full text-sm font-semibold shadow-lg">
                            <?php echo e($university->type == 'public' ? __('messages.public') : __('messages.private')); ?>
    ...
    <div class="container mx-auto px-4 py-10">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-4 mb-12 animate-fadeUp">
            <div class="stat-card bg-white rounded-2xl shadow-md p-5 text-center border-b-4 border-yellow-500 hover:shadow-xl transition">
                ...
                <p class="text-gray-500 text-sm mt-1"><?php echo e(__('messages.local_rank')); ?></p>
            </div>
            <div class="stat-card bg-white rounded-2xl shadow-md p-5 text-center border-b-4 border-yellow-500 hover:shadow-xl transition">
                <div class="text-3xl mb-2">🏙️</div>
                <p class="text-2xl font-bold text-gray-800"><?php echo e($university->city); ?></p>
                <p class="text-gray-500 text-sm mt-1"><?php echo e(__('messages.city')); ?></p>
            </div>
            <div class="stat-card bg-white rounded-2xl shadow-md p-5 text-center border-b-4 border-yellow-500 hover:shadow-xl transition">
               <div class="text-3xl mb-2">🌐</div>
    ...
    <p class="text-gray-500 text-sm mt-1"><?php echo e(__('messages.study_languages')); ?></p>
            ...
            <div class="stat-card bg-white rounded-2xl shadow-md p-5 text-center border-b-4 border-yellow-500 hover:shadow-xl transition">
                ...
                <?php if($university->website): ?>
                    <a href="<?php echo e($university->website); ?>" target="_blank"
                        class="text-blue-600 text-sm hover:underline font-medium"><?php echo e(__('messages.visit_website')); ?></a>
                <?php else: ?>
                    <p class="text-gray-400">—</p>
                <?php endif; ?>
                <p class="text-gray-500 text-sm mt-1"><?php echo e(__('messages.electronic_website')); ?></p>
            </div>
        </div>
        ...
        <div class="bg-white rounded-2xl shadow-xl overflow-hidden animate-fadeUp">
            ...
            <div class="flex flex-wrap border-b border-gray-200 bg-gray-50">
                <button onclick="showTab('about')" id="tabAbout"
                    class="tab-active px-6 py-3 font-semibold transition rounded-t-lg"> <?php echo e(__('messages.university')); ?></button>
                <button onclick="showTab('specialties')" id="tabSpecialties"
                    class="tab-inactive px-6 py-3 font-semibold transition rounded-t-lg"> <?php echo e(__('messages.specialties')); ?></button>
                <button onclick="showTab('admissions')" id="tabAdmissions"
                    class="tab-inactive px-6 py-3 font-semibold transition rounded-t-lg"> <?php echo e(__('messages.admissions')); ?></button>
                <button onclick="showTab('postgraduateQuotas')" id="tabPostgraduateQuotas"
                    class="tab-inactive px-6 py-3 font-semibold transition"> <?php echo e(__('messages.postgraduate_admissions')); ?></button>
                <button onclick="showTab('video')" id="tabVideo"
                    class="tab-inactive px-6 py-3 font-semibold transition rounded-t-lg"> <?php echo e(__('messages.intro_video')); ?></button>
                <button onclick="showTab('gallery')" id="tabGallery"
                    class="tab-inactive px-6 py-3 font-semibold transition rounded-t-lg"> <?php echo e(__('messages.photo_gallery')); ?></button>
...
<?php if($university->type == 'private'): ?>
    <button onclick="showTab('programs')" id="tabPrograms" class="tab-inactive px-6 py-3 font-semibold transition rounded-t-lg">
        <?php echo e(__('messages.postgraduate_programs')); ?>
...
<?php endif; ?>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div class="bg-gradient-to-br from-gray-50 to-gray-100 rounded-2xl p-6 shadow-inner">
                        <h3 class="font-bold text-gray-800 mb-4 text-lg flex items-center gap-2">
                           ...
                           <?php echo e(__('messages.university_info')); ?>

                        </h3>
                        <div class="space-y-3">
                            <div class="flex justify-between items-center border-b border-gray-200 pb-2">
                                <span class="text-gray-500"><?php echo e(__('messages.type')); ?></span>
                                <span class="text-gray-800 font-semibold"><?php echo e($university->type == 'public' ? __('messages.public') : __('messages.private')); ?></span>
                            </div>
                            <div class="flex justify-between items-center border-b border-gray-200 pb-2">
                                <span class="text-gray-500"><?php echo e(__('messages.city')); ?></span>
                                <span class="text-gray-800 font-semibold"><?php echo e($university->city); ?></span>
                            </div>
                            <div class="flex justify-between items-center border-b border-gray-200 pb-2">
                                <span class="text-gray-500"><?php echo e(__('messages.local_rank')); ?></span>
                                <span class="text-gray-800 font-semibold"><?php echo e($university->rank_local ?? __('messages.not_specified')); ?></span>
                            </div>
                            <?php if($university->website): ?>
                                <div class="flex justify-between items-center pt-1">
                                    <span class="text-gray-500"><?php echo e(__('messages.electronic_website')); ?></span>
                                    <a href="<?php echo e($university->website); ?>" target="_blank"
                                        class="text-yellow-600 hover:underline text-sm"><?php echo e(__('messages.visit_website')); ?></a>
                                </div>
                            <?php endif; ?>
                        </div>
                    </div>
            ...
            <div id="specialtiesTab" class="p-6 hidden">
                <div class="flex justify-center gap-4 mb-8">
                    <button id="btnColleges" onclick="showSpecialtyType('colleges')"
                        class="tab-active px-8 py-2 rounded-xl font-semibold transition shadow-md">🏛️ <?php echo e(__('messages.colleges')); ?></button>
                    <button id="btnInstitutes" onclick="showSpecialtyType('institutes')"
                        class="tab-inactive px-8 py-2 rounded-xl font-semibold transition shadow-md">📚 <?php echo e(__('messages.institutes')); ?></button>
                </div>
                                ...
                                <div class="flex justify-between items-start flex-wrap gap-2">
                                    ...
                                    <?php if($university->type == 'private' && !empty($college->pivot->fee)): ?>
                                        <div class="bg-green-50 px-3 py-1.5 rounded-xl text-center min-w-[90px]">
                                            ...
                                            <span class="text-green-500 text-xs block"><?php echo e(__('messages.per_year')); ?></span>
                                        </div>
                                    <?php endif; ?>
                                </div>
                            </div>
            ...
            <div id="admissionsTab" class="p-6 hidden">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center flex items-center justify-center gap-2">
                    <span>📅</span> <?php echo e(__('messages.admissions')); ?>
                            ...
                            <div class="bg-gradient-to-r from-gray-50 to-white rounded-xl p-5 border-r-4 border-yellow-500 hover:shadow-md transition">
                                <div class="flex flex-wrap justify-between items-center mb-3">
                                    <div class="flex items-center gap-2">
                                        <span class="font-bold text-gray-800 text-lg"><?php echo e(__('messages.competition')); ?> <?php echo e($quota->competition_number); ?></span>
...
<a href="https://wa.me/<?php echo e($whatsapp); ?>?text=أرغب%20في%20التسجيل%20في%20المفاضلة%20التالي:%0A📅%20التاريخ:%20<?php echo e($quota->date ?? 'غير محدد'); ?>%0A🏛️%20الجامعة:%20<?php echo e($university->name_ar); ?>%0A📚%20التخصص:%20<?php echo e($quota->major_name ?? 'غير محدد'); ?>"
 ...
 <?php echo e(__('messages.register_through_us')); ?>

</a>
                                </div>
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                                    <div><span class="text-gray-500 block text-xs">📅 <?php echo e(__('messages.registration_start')); ?></span><span class="font-semibold"><?php echo e(\Carbon\Carbon::parse($quota->registration_start)->format('d/m/Y')); ?></span></div>
                                    <div><span class="text-gray-500 block text-xs">⏰ <?php echo e(__('messages.registration_end')); ?></span><span class="font-semibold text-red-600"><?php echo e(\Carbon\Carbon::parse($quota->registration_end)->format('d/m/Y')); ?></span></div>
                                    <div><span class="text-gray-500 block text-xs">📊 <?php echo e(__('messages.results')); ?></span><span><?php echo e($quota->results_date ? \Carbon\Carbon::parse($quota->results_date)->format('d/m/Y') : '—'); ?></span></div>
                                    <div><span class="text-gray-500 block text-xs">📜 <?php echo e(__('messages.accepted_certificates')); ?></span>
                                ...
                                <?php if($quota->details): ?>
                                    <div class="mt-3 pt-2 border-t border-gray-100 text-sm text-gray-500">📋 <?php echo e(__('messages.details')); ?>: <?php echo e($quota->details); ?></div>
                                <?php endif; ?>
                            </div>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </div>
                <?php else: ?>
                    <div class="bg-yellow-50 rounded-xl p-8 text-center border-r-4 border-yellow-500">
                        <p class="text-yellow-800"><?php echo e(__('messages.no_admissions')); ?></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div id="postgraduateQuotasTab" class="p-6 hidden">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center flex items-center justify-center gap-2">
                    <span>🎓</span> <?php echo e(__('messages.postgraduate_admissions')); ?>
...
<a href="https://wa.me/<?php echo e($whatsapp); ?>?text=أرغب%20في%20التسجيل%20في%20المفاضلة%20التالي:%0A📅%20التاريخ:%20<?php echo e($quota->date ?? 'غير محدد'); ?>%0A🏛️%20الجامعة:%20<?php echo e($university->name_ar); ?>%0A📚%20التخصص:%20<?php echo e($quota->major_name ?? 'غير محدد'); ?>"
   ...
   <?php echo e(__('messages.register_through_us')); ?>
                                ...
                                <?php if($quota->institute): ?>
                                    <div class="mb-3">
                                        <span class="text-xs text-gray-500"><?php echo e(__('messages.institute')); ?></span>
                ...
                <?php else: ?>
                    <div class="bg-yellow-50 rounded-xl p-8 text-center border-r-4 border-yellow-500">
                        <p class="text-yellow-800"><?php echo e(__('messages.no_postgraduate_admissions')); ?></p>
                    </div>
                <?php endif; ?>
            </div>
            ...
            <div id="videoTab" class="p-6 hidden">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center flex items-center justify-center gap-2">
                    <span>🎥</span> <?php echo e(__('messages.intro_video')); ?>
                ...
                <?php else: ?>
                    <div class="bg-gray-100 rounded-2xl p-12 text-center">
                        ...
                        <p class="text-gray-500"><?php echo e(__('messages.no_video_available')); ?></p>
                    </div>
                <?php endif; ?>
            </div>
...
<div id="galleryTab" class="p-6 hidden">
    <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center flex items-center justify-center gap-2">
        <span>🖼️</span> <?php echo e(__('messages.photo_gallery')); ?>
...
<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        ...
        <?php else: ?>
            <div class="bg-gray-50 rounded-xl p-12 text-center border-2 border-dashed border-gray-200">
                ...
                <p class="text-gray-500 text-lg"><?php echo e(__('messages.photo_gallery')); ?></p>
                <p class="text-gray-400 text-sm mt-2">س<?php echo e(__('messages.no_images_available')); ?></p>
            </div>
        <?php endif; ?>
    <?php else: ?>
        <div class="bg-gray-50 rounded-xl p-12 text-center border-2 border-dashed border-gray-200">
            <div class="text-6xl mb-4">🖼️</div>
            <p class="text-gray-500 text-lg"><?php echo e(__('messages.photo_gallery')); ?></p>
            <p class="text-gray-400 text-sm mt-2"><?php echo e(__('messages.no_images_available')); ?></p>
        </div>
    <?php endif; ?>
</div>
...
<div id="programsTab" class="p-6 hidden">
    <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center flex items-center justify-center gap-2">
        <span>🎓</span> <?php echo e(__('messages.postgraduate_programs')); ?>
    ...
    <?php if($university->type == 'private'): ?>
        ...
        <div id="masterSection">
            ...
            <?php else: ?>
                <div class="bg-yellow-50 rounded-xl p-8 text-center border-r-4 border-yellow-500">
                    ...
                    <p class="text-yellow-800"><?php echo e(__('messages.no_postgraduate_programs')); ?></p>
                    <p class="text-yellow-600 text-sm mt-2"><?php echo e(__('messages.programs_coming_soon')); ?></p>
                </div>
            <?php endif; ?>
        </div>
        ...
        <div id="phdSection" class="hidden">
            ...
            <?php else: ?>
                <div class="bg-yellow-50 rounded-xl p-8 text-center border-r-4 border-yellow-500">
                    <div class="text-4xl mb-3">📚</div>
                    <p class="text-yellow-800"><?php echo e(__('messages.no_phd_programs')); ?></p>
                    <p class="text-yellow-600 text-sm mt-2"><?php echo e(__('messages.programs_coming_soon')); ?></p>
                </div>
            <?php endif; ?>
        </div>
    <?php else: ?>
        <div class="bg-blue-50 rounded-xl p-8 text-center border-r-4 border-blue-500">
            ...
            <p class="text-blue-800 text-lg"><?php echo e(__('messages.government_university')); ?></p>
            <p class="text-blue-600 text-sm mt-2"><?php echo e(__('messages.postgraduate_programs_only')); ?></p>
        </div>
    <?php endif; ?>
</div>
<?php endif; ?>
        ...
        <?php if($otherUniversities->count() > 0): ?>
            <div class="mt-12">
                <h2 class="text-2xl font-bold text-gray-800 mb-6 text-center flex items-center justify-center gap-2">
                    <span>🎓</span> <?php echo e(__('messages.other_universities')); ?>
...
<?php /**PATH C:\laragon\www\testproject-main\resources\views/universities/show.blade.php ENDPATH**/ ?>