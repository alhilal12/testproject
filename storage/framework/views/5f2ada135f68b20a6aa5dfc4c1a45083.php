<?php if($announcements->count() > 0): ?>
                        ...
                        <div class="swiper-slide">
                            <div class="relative h-[400px] md:h-[500px] w-full">
                                ...
                                <?php if($announcement->image): ?>
                                    <img src="<?php echo e(asset('storage/' . $announcement->image)); ?>" alt="<?php echo e($announcement->title_ar); ?>"
                                ...
                                <div
                                    ...
                                    <div class="max-w-3xl relative z-10">
                                        ...
                                        <h2
                                            ...
                                            <?php echo e($announcement->title_ar); ?>
                                        ...
                                        <p
                                            ...
                                            <?php echo e($announcement->description_ar); ?>

                                        </p>

                                        <!-- Button -->
                                        <?php if($announcement->link): ?>
                                            <a href="<?php echo e($announcement->link); ?>" target="_blank"
    ...
    <?php $__env->stopPush(); ?>
<?php endif; ?><?php /**PATH C:\Users\DELL\Desktop\testproject-master\testproject-master\resources\views/components/announcements-slider.blade.php ENDPATH**/ ?>