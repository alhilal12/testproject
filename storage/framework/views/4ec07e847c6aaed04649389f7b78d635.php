    ...
    <div class="container mx-auto px-4 py-12">
        ...
        <label class="flex items-center gap-2 cursor-pointer">
            <input type="checkbox" name="hide_expired" value="true" 
                   <?php echo e(request('hide_expired') == 'true' ? 'checked' : ''); ?>
            ...
            <span class="text-sm text-gray-700">📅 إخفاء المفاضلات المنتهية</span>
                    ...
                    <div>
                        ...
                        <a href="<?php echo e(route('university-quotas.index', ['type' => $viewType])); ?>" class="bg-gray-200 text-gray-700 px-4 py-2 rounded-lg hover:bg-gray-300 transition ml-2">
                            إعادة تعيين
                        </a>
                    </div>
                </div>
...
<tbody>
    <?php $__empty_1 = true; $__currentLoopData = $quotas; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $index => $quota): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
        ...
        <tr class="border-b hover:bg-gray-50 transition <?php echo e($isExpired ? 'deadline-ended' : ''); ?>">
            ...
            <td class="px-4 py-3 font-semibold text-gray-800"><?php echo e($quota->university_name_tr ?? '—'); ?></td>
...
<?php endif; ?>
            ...
            <td class="px-4 py-3 text-center">
                <span class="<?php echo e($quota->fee == 'مجانا' ? 'text-green-600 font-bold' : 'text-gray-700'); ?>">
    ...
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
        <tr>
            <td colspan="<?php echo e($viewType == 'postgraduate' ? 12 : 11); ?>" class="text-center py-16 text-gray-500">
